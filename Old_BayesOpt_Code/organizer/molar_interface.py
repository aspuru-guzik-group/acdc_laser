...
class MolarInterface:
    ...
    @_try_else_return_none
    def get_lab_avail_frags(self, lab, available='True'):
        ''' Return the available fragments at a specific laboratory

        Parameters:
            lab (str): Name of the lab
            available (str): the availability of the fragment ("True" or "False")
        ...
        return request[['lab_molecule.lab_molecule_id',
                        'lab_molecule.updated_on',
                        'lab_molecule.available',
                        'lab_molecule.lab_id',
                        'lab_molecule.molecule_id',
                        'lab.lab_id',
                        'lab.name',
    ...
    def get_fragment_details(self, identifier, identifier_type="hid"):
        ...
        if request is not None:
            ...
            data_dict = {"id": request.at[0, "hid"], "smiles": request.at[0, "smiles"], "molecule_id": request.at[0, "molecule_id"]}
    ...
    def create_target_compound(self, smiles, fragment_a, fragment_b, fragment_c, fragment_identifier="hid"):
        ...
        """
        frag_a = self.get_fragment_details(fragment_a, identifier_type=fragment_identifier)
        frag_b = self.get_fragment_details(fragment_b, identifier_type=fragment_identifier)
        frag_c = self.get_fragment_details(fragment_c, identifier_type=fragment_identifier)
        ...
        mol = self.client.create_entry(
            ...
            data={
                ...
                "hid": frag_a["id"]+frag_b["id"]+frag_c["id"]
            }
        )
